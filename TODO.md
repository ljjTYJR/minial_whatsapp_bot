# The plan to implement a minimal clawbot

## Todo list
- [x] make the structure of the project
- [x] Implement the basic model setting (with openrouter) and chat with it.
- [x] Add loop that can continue to chat.
